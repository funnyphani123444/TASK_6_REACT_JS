                                        ...
                                        <div class="row text-light">
                                            <div class="col-6 text-center">
                                                <div class="about-info mt-5">
                                                    <p><span className="fs-2">Phani</span></p>
                                                    <p><span className="fs-4">Robotic Engineer And Developer</span></p>
                                                    <p><span>@funnyphani123444</span></p>
                                                    <a className="btn btn-success" href="#contact">Contact Me!</a>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <img src={require("./Phani.jpeg")} alt="" style={{
                                                    height: "300px",
                                                    padding: "15px",
                                                    display: "block",
                                                    marginLeft: "auto",
                                            ...
                                            <div class="col-12 p-4">
                                                <div class="about-me pt-4 pt-md-0">
                                                    ...
                                                    <p>
                                                    I'm a complex individual who values introspection, passion, and personal growth. I hold dear the few, meaningful connections I've cultivated. Each day, I approach life with quiet enthusiasm, painting my existence with rich experiences and continuous self-improvement.
                                                    </p>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div className="container m-5">
                ...
                <div className="row">
                    <ul className="col-12 col-xxl-6 list-group mt-5 ps-4">
                        ...
                        <li className="list-group-item"><span className="fw-bold">Full Name: Jada Phani Kumar</span></li>
                        <li className="list-group-item"><span className="fw-bold">Birthday: 19th November 2003</span></li>
                    ...
                    <ul className="col-12 col-xxl-6 list-group mt-5 pe-4">
                        <li className="list-group-item"><span className="fw-bold">Git Profile: </span><a className="link" href="https://github.com/funnyphani123444">Click here</a></li>
